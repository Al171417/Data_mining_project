...
def welcome():
    ...
    image = Image.open('DaFiT_logo.jpg')
...
def data_obs_intro():
    ...
    image = Image.open('data_visual_im.jpeg')
...
def formatting_data_intro():
    ...
    image = Image.open('data_formatting_img.png')
...
def ml_regressions_intro():
    ...
    image = Image.open('ML_ linear_model_image.png')
